      ...
      <nav class="flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center space-x-8">
          ...
          >
            {{ link.name }}
            <span
              class="absolute bottom-0 left-0 w-full h-0.5 transition-all duration-300 transform origin-left scale-x-0 group-hover:scale-x-100"
              :class="
                link.path === $route.path
                  ? 'bg-emerald-500 scale-x-100'
                  : 'bg-emerald-500 group-hover:scale-x-100'
              "
            ></span>
          </NuxtLink>
          <NuxtLink
        ...
        >
          <div
            class="w-6 h-5 relative transform transition-all duration-300 flex flex-col justify-center"
            :class="{ 'rotate-180': isMobileMenuOpen }"
          >
            <span
              class="absolute h-0.5 w-full bg-slate-900 transform transition-all duration-300"
              :class="{
