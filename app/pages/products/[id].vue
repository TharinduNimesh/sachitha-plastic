      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="mb-8">
          <ol class="flex items-center space-x-2 text-sm">
            <li>
              <NuxtLink
                to="/"
                class="text-slate-600 hover:text-emerald-600 font-semibold"
              >
                Home
              </NuxtLink>
            </li>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 my-12">
          ...
          <div class="my-12">
            <!-- Image Slider -->
            <div
              class="relative aspect-[3/2] rounded-2xl overflow-hidden bg-slate-100"
            >
              <img
