    ...
    <div class="min-h-screen bg-gradient-to-br py-24">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="relative max-w-2xl">
              <form @submit.prevent="handleSearch" class="relative">
                <input type="text" v-model="searchInput" placeholder="Search products by name, category or status..."
            ...
            <div class="flex flex-wrap items-center gap-4">
              ...
              <div class="flex items-center gap-3 ml-auto">
                ...
                <div class="relative" ref="sortMenuRef">
                  <button @click="isSortMenuOpen = !isSortMenuOpen"
                    class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors duration-200">
                  ...
                  <div v-if="isSortMenuOpen"
                    ...
                    <button v-for="option in sortOptions" :key="option.value" @click="selectSortOption(option.value)"
        ...
        <div v-if="filteredProducts.length > 0">
          ...
          <WebProductLatestProduct />
          <!-- trending products -->
          <WebProductTrendingProducts />
          ...
          <div class="mt-16">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-8">
              ...
              <div class="flex items-center gap-4 mt-4 md:mt-0">
                <button @click="viewMode = 'grid'" class="flex items-center gap-2 px-4 py-2 transition-colors" :class="viewMode === 'grid'
                  ? 'text-emerald-600'
                ...
                <button @click="viewMode = 'list'" class="flex items-center gap-2 px-4 py-2 transition-colors" :class="viewMode === 'list'
                  ? 'text-emerald-600'
                  : 'text-slate-600 hover:text-emerald-600'
                  ">
            ...
            <div v-if="viewMode === 'grid'"
              ...
              <WebProductCard v-for="product in filteredProducts.slice(0, displayedItems)" :key="product.id"
                :product="product" class="transition-all duration-300 hover:-translate-y-1" />
            </div>

            <!-- List View -->
            <div v-else class="space-y-4">
              <div v-for="product in filteredProducts.slice(0, displayedItems)" :key="product.id"
